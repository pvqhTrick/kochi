		...
		<div class="catlistBtn">
			<ul class="catlist wraper">
				...
				foreach ($catList as $catItem): ?>
					<li>
						<a class="hoverJS" href="<?php echo get_term_link($catItem) ?>"><img src="<?php echo get_theme_file_uri() . '/img/index/toparea4_cat' . $catItem->slug . '.png' ?>" alt="<?php echo $catItem->name ?>"></a>
					</li>
				<?php endforeach; ?>
			</ul>
		</div>
